...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <p><a class="btn btn-default" role="button" href="html/oldadmin.jsp">Admin page &raquo;</a></p>
        </div>
        <div class="col-md-4">
            <h2>Heading</h2>
            <p>Empty </p>
            <p><a class="btn btn-default" role="button" href="html/admin/admin.jsp" role="button">Temp empty button 1 &raquo;</a></p>
        </div>
        <div class="col-md-4">
            <h2>Heading</h2>
            <p>Empty</p>
