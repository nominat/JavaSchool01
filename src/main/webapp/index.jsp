    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img src="html/img/truck1.jpg" alt="Truck" width="460" height="345">
            </div>

            <div class="item">
                <img src="html/img/truck2.jpg" alt="Truck" width="460" height="345">
            </div>

            <div class="item">
                <img src="html/img/truck3.jpg" alt="Truck" width="460" height="345">
            </div>

            <div class="item">
                <img src="html/img/truck4.jpg" alt="Truck" width="460" height="345">
            </div>
        </div>
